    ...
    <div className="main-container">
      <div className='d-flex'>
        <div className='file_upload_container'>
          ...
          <div className='p-5' onClick={navigate(`/chatbot/${uniqueId}`)}>
            <input
              type="file"
            ...
            <div className='file-name'>
              ...
              files.map((file) => (
                <div key={file._id} onClick={() => {
                  console.log(file); // Check if file has _id and other properties
                  handleHistory();
                  handleClosePopup();
                  handlFileName(file);
                ...
                <div className='s-align'>
                  <div className='search-input'>
                    ...
                    <img
                      ...
                      alt="Send"
                      style={{ cursor: isLoading || extractedText.length === 0 ? 'not-allowed' : 'pointer' }}
                    />
                  </div>
                </div>
              </div>
